...
exports.cashSessionJournalRepository = void 0;
...
function isTuitionCategory(name) {
    const lower = name.toLowerCase();
    return TUITION_KEYWORDS.some((kw) => lower.includes(kw));
}
exports.cashSessionJournalRepository = {
    async listJournalPayments(session, filters) {
...
//# sourceMappingURL=cashSessionJournal.repository.js.map