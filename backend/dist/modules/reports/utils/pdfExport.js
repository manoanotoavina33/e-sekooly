...
exports.streamReportPdf = streamReportPdf;
 ...
 * rapports.
 */
function streamReportPdf(res, title, columns, rows) {
    const doc = new pdfkit_1.default({ margin: 36, size: "A4", layout: columns.length > 5 ? "landscape" : "portrait" });
